...
func TestCreateSegment(t *testing.T) {
	...
	expectedStartTime, _ := time.Parse("2006-01-02 15:04:05.000", "2025-10-29 15:40:47.814")
	expectedEndTime, _ := time.Parse("2006-01-02 15:04:05.000", "2025-10-29 15:41:28.985")
...
func TestSegmentIndexCreation(t *testing.T) {

	entry := []string{
		`2025-10-29 15:40:47.814 | DEBUG | auth | host=db01 | request_id=req-rrfym6-7292 | msg="Session terminated"`,
		`2025-10-29 15:40:48.118 | ERROR | worker | host=web02 | request_id=req-rrfym6-7292 | msg="Transaction rolled back"`,
